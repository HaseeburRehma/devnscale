/**
 * The tiled "Logo Mark" watermark that sits behind the dark sections
 * (Process, Testimonial, Footer). Path data is the Figma logo-mark vector;
 * it tiles at 51.1 x 62.9 with a slight scale-up, at low opacity.
 */
    ...
    >
      <svg width="100%" height="100%">
        <defs>
          ...
          >
            <g transform="scale(1.4)" fill="none" stroke="#ffffff" strokeWidth="1.2">
